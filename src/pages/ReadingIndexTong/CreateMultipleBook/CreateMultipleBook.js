...
import { fetchAllReadingIndexTotal, fetchCreateReadingIndexTotal } from "../../../redux/slices/readingIndexTotalSlice/readingIndexTotalSlice";
...
export const CreateMultipleBook = (props) => {
  ...
  const handleCreateBook = async () => {
    ...
    try {
      ...
      await dispatch(fetchCreateReadingIndexTotal(values));
