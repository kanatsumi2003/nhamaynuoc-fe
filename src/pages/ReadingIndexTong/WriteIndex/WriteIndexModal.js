...
import { FormSearchWriteModalIndexTong } from "../../../components/FormSearchReadingIndex/FormSearchWriteModalIndexTong";
        ...
        <>
          ...
          >
            {data
              ...
              .map((item) => {
                return <Frame1 item={item} setSelector={setSelector} />;
              })}
          </Row>
          <Row
            style={{
