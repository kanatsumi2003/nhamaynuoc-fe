...
import {
  ...
  btnClickTabListInvoiceSeriSelector,
} from "../../../redux/selector";
import tabListInvoicePrintSlice from "../../../redux/slices/tabListInvoicePrintSlice/tabListInvoicePrintSlice";
import "./SeriInvoice.css";
import AddListSeri from "./AddListSeri";
import EditListLocation from "./EditListSeri";
import {
  fetchDeleteWatch,
  fetchWatchData,
} from "../../../redux/slices/watchSlice/watchSlice";
import Captcha from "../../../components/Captcha/Captcha";
import tabListInvoiceSeriSlice from "../../../redux/slices/tabListInvoiceSeriSlice/tabListInvoiceSeriSlice";
import { fetchDeleteSeri, getAllSeriInvoice } from "../../../redux/slices/seriInvoiceSlice/seriInvoiceSlice";
...
function TableListSeri({ isTabletOrMobile }) {
  ...
  const tabListbc = useSelector(btnClickTabListInvoiceSeriSelector);
  ...
  const handleConfirmDeleteWatch = () => {
    if (rowSelected) {
      dispatch(fetchDeleteSeri({ keyId: rowSelected.keyId }));
      setIsCaptcha(false);
  ...
  const hideModal = () => {
    ...
    dispatch(tabListInvoiceSeriSlice.actions.btnClickTabListInvoiceSeri(null));
  };
  ...
  return (
    <>
      ...
      >
        ...
        <AddListSeri tabListbc={tabListbc} hideModal={hideModal} />
      </Modal>
      <Modal
