...
function FormFilterCollectionBill() {
  ...
  return (
    ...
    >
      <Row>
        ...
        {/* Tìm kiếm nhân viên */}
        <Col xs={24} sm={12} md={12} lg={12}>
          <Form.Item name="timKiemNhanVien" label="Tìm kiếm NV: ">
            <Input name="timKiemNhanVien" placeholder="Nhập tên nhân viên" />
          </Form.Item>
        </Col>
...
export default FormFilterCollectionBill;
