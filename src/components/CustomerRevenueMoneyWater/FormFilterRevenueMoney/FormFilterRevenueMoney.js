...
function FormFilterRevenueMoney() {
  ...
  return (
    <Form
      ...
      fields={[
        ...
        { name: "tieuChi", value: "TieuThuLonHon0" },
      ]}
    >
      <Row>
        {/* Đơn vị */}
        ...
        {/* Tình trạng thu */}
        <Col xs={24} sm={12} md={12} lg={12}>
          <Form.Item name="tinhTrangThu" label="Tình trạng: ">
            <Select
        ...
        <Col xs={24} sm={12} md={12} lg={12}>
          <Form.Item name="tieuChi" label="Tiêu chí: ">
            <Select
              ...
              options={[
                {
                  value: "TieuThuLonHon0",
                  label: "Lấy khách hàng có tiêu thụ > 0",
                },
                { value: "TatCaKH", label: "Lấy tất cả khách hàng" },
              ]}
        ...
        {/* Tài khoản nhân viên */}
        <Col xs={24} sm={12} md={12} lg={12}>
          <Form.Item name="tkNhanVien" label="TK nhân viên: ">
            <Input name="tkNhanVien" placeholder="Nhập tài khoản nhân viên" />
          </Form.Item>
        </Col>
...
export default FormFilterRevenueMoney;
