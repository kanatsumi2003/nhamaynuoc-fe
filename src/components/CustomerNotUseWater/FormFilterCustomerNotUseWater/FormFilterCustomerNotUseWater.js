...
function FormFilterCustomerNotUseWater() {
  ...
  return (
    ...
    >
      <Row>
        ...
        {/* Số tháng không sd nước */}
        <Col xs={24} sm={12} md={12} lg={12}>
          <Form.Item name="soThang" label="Số tháng">
            <Input name="soThang" placeholder="Nhập số tháng không dùng nước" />
          </Form.Item>
        </Col>
...
export default FormFilterCustomerNotUseWater;
