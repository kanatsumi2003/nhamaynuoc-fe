...
import { addThatThoatDongHoTong } from "../../../redux/slices/waterLossSlice/waterLossSlice";
import { setRowSelectedSelector } from "../../../redux/selector";

const ViewDetailMasterClock = ({ hideModal }) => {
  ...
  const handleSubmit = (values) => {
    ...
    values.thangTaoThatThoat= dayjs(values.thangTaoThatThoat).format("MM/YYYY")
    console.log("values", values);
    dispatch(addThatThoatDongHoTong(values))
  };
...
export default ViewDetailMasterClock;
