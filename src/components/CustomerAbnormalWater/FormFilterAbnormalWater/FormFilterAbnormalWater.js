...
function FormFilterAbnormalWater() {
  ...
  return (
    ...
    >
      <Row>
        ...
        {/* % Chênh lệch */}
        <Col xs={24} sm={12} md={12} lg={12}>
          <Form.Item name="trenLech" label="% Chênh lệch">
            <Input
              name="trenLech"
              placeholder="Nhập phần trăm chênh lệch với tháng trước"
            />
          </Form.Item>
        </Col>

        {/* Chỉ kiểm tra các hộ có mức tiêu thụ >= */}
        <Col xs={24} sm={12} md={12} lg={12}>
          <Form.Item
            name="ktMucTieuThu"
            label="KT mức tiêu thụ"
            layout={layout}
            rules={[
              {
                required: true,
          ...
          >
            <InputNumber
              style={{ width: "100%" }}
              name="ktMucTieuThu"
              placeholder="Chỉ kiểm tra các hộ có mức tiêu thụ >="
            />
          </Form.Item>
        </Col>
      </Row>
...
export default FormFilterAbnormalWater;
